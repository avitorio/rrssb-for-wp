...
/**
 * Class file for RRSSB buttons templates, icons,...
 *
 * @link       http://www.codigitus.com
 * @since      1.0.0
 */

class Rrssb_For_Wp_Buttons {
	protected $buttons;

	public function __construct( $type, $buttons ) {
		...
		if ( $type == 'inactive' ) {
			...
			$this->buttons = array_diff( $all_buttons, $buttons );
		} else {
			$this->buttons = $buttons;
		}
	}

	public function make_list_buttons() {
		$buttons_list = '';
		foreach ( $this->buttons as $button ) {
			$buttons_list .= $this->make_button( $button );
		}
	...
	private function make_button( $button ) {
		...
		$button_template .= '<span class="rrssb-text">' . $text . '</span></a></li>';

		return $button_template;
	}

	private function button_icon( $button ) {
		switch ( $button ) {
			case 'email':
				$button_icon = '<span class="rrssb-icon">
			...
			case 'twitter':
				$button_icon = '<span class="rrssb-icon"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewbox="0 0 28 28">
	...
	public static function show_buttons($id, $plugin_name) {
